    ...
    override fun onCreateView(
        ...
        *  */
        ...
        (activity as DetectionActivity).initNavigationQuestion(
            ...
            prevFragment = DetectionActivity.fragmentAlopecia,
            nextQuestion = binding.nextQuestion,
            nextFragment = DetectionActivity.fragmentConfirm,
            nextValidation = (activity as DetectionActivity).checkQuestionIsFilled(Constanta.DiabetesSympthoms.Obesity.name)
        )

        /* init progress filled -> percentage current step of 15 question */
        binding.progressBar.progress = 94

        /* init progress filled -> percentage current step of 15 question */
        binding.imageQuestion.setImageDrawable((activity as DetectionActivity).getDrawable(R.drawable.img_obesity))
        binding.question.text = resources.getString(R.string.question_about_obesity)
